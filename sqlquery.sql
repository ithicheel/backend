...
create table start_backend.category (
    ...
    cate_name varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL UNIQUE,
...
values("sdfjksdfdsfjl34534fdd", "admin@backend.com", "admin1234", "2021-01-29 3:27", "a");
...
where  product_cate_id = "cateidvtrkt1jokz156ijj";
